...
train <- read.csv("C:/Users/Dell/Desktop/Data Analysis/Projects/Predicting-the-Business-License-Status-master/train_file.csv",
                              sep = ",", header = T)
test <- read.csv("C:/Users/Dell/Desktop/Data Analysis/Projects/Predicting-the-Business-License-Status-master/test_file.csv",
                 sep = ",",header = T)
